...
export default function CheckoutPage() {
  ...
  const [trackingNumber] = useState(() => `FS${Math.random().toString(36).substring(2, 10).toUpperCase()}${Date.now().toString().slice(-6)}`);
            ...
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6">
              <div className="flex items-center gap-3 text-white">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">Your order delivery details</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg border border-purple-100">
                    ...
                    <p className="text-lg font-bold text-gray-900">FastShip Express</p>
                    <p className="text-xs text-gray-600 mt-1">Tracking available after shipment</p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg border border-orange-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm font-mono text-gray-700 bg-white px-3 py-2 rounded border border-orange-200">
                        {trackingNumber}
                      </p>
                      <p className="text-xs text-gray-600 mt-2">
                        📦 You'll receive tracking updates via email once your order ships
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-sm text-gray-700">
                    <span className="font-semibold">Note:</span> Delivery times are estimates and may vary based on your location and carrier processing times.
                  </p>
                </div>
              </div>
            </div>
